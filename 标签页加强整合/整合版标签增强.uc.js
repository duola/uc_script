    (function() {
    // ==UserScript==
    // [url=home.php?mod=space&uid=467097]@Name[/url] NewTabPlus_mod
    // @description 整合版标签增强
    // [url=home.php?mod=space&uid=713796]@include[/url] chrome://browser/content/browser.xul
    ...
    replace('w.gBrowser.selectedTab.pinned', '(!w.isTabEmpty(w.gBrowser.selectedTab) || [        DISCUZ_CODE_0        ])').
